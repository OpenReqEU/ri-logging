"use strict";const endpoint_url="http//:0.0.0.0:9798/frontend/log";function generateSessionId(){let length=20;let sessionId="";let possible="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789";for(let i=0;i<length;i++){sessionId+=possible.charAt(Math.floor(Math.random()*possible.length));}
return sessionId;}
